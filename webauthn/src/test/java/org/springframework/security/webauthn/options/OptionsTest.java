...
public class OptionsTest {
	...
	public void equals_hashCode_test() {
		...
		Options instanceA =
				new Options(rpEntity, userEntity, challenge, pubKeyCredParams, registrationTimeout, authenticationTimeout,
						credentialIds, authenticatorSelection, attestation, registrationExtensionsClientInputs, authenticationExtensionsClientInputs, parameters);
		Options instanceB =
				new Options(rpEntity, userEntity, challenge, pubKeyCredParams, registrationTimeout, authenticationTimeout,
						credentialIds, authenticatorSelection, attestation, registrationExtensionsClientInputs, authenticationExtensionsClientInputs, parameters);
