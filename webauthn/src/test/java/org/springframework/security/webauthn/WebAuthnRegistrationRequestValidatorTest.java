...
public class WebAuthnRegistrationRequestValidatorTest {
	...
	@Before
	public void setup(){
		target = new WebAuthnRegistrationRequestValidator(webAuthnAuthenticationManager, webAuthnServerPropertyProvider);
	}
	...
	public void validate_test() {
		...
		doNothing().when(webAuthnAuthenticationManager).verifyRegistrationData(any());
		...
		verify(webAuthnAuthenticationManager).verifyRegistrationData(argumentCaptor.capture());
