 ...
 */
public class KeyStoreResourceTrustAnchorsProvider extends CachingTrustAnchorsProviderBase implements InitializingBean {
	...
	public KeyStoreResourceTrustAnchorsProvider() {
	}

	public KeyStoreResourceTrustAnchorsProvider(Resource keyStore) {
