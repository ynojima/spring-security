...
package org.springframework.security.webauthn.sample.domain.constant;
...
public class DomainTypeTokens {
	...
	public static final Type AuthenticatorEntityList = new TypeToken<ArrayList<org.springframework.security.webauthn.sample.domain.entity.AuthenticatorEntity>>() {
	}.getType();
