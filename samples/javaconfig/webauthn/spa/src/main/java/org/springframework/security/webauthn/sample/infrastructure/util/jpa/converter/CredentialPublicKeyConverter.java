...
package org.springframework.security.webauthn.sample.infrastructure.util.jpa.converter;
...
public class CredentialPublicKeyConverter implements AttributeConverter<CredentialPublicKey, String> {
	...
	public CredentialPublicKeyConverter() {
		this.cborConverter = new CborConverter();
	}

// The code below takes CborConverter instance from Spring ApplicationContext,
// but it is supported on Hibernate 5.3.0 or later
